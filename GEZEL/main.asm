...
; This file was generated Sun Dec  2 11:31:30 2012
;--------------------------------------------------------
	.module main
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:29: void write_montgomery() {
;	-----------------------------------------
...
;	main.c:40: for (i = 0; i < SIZE; i++) {
	...
	sjmp	00112$
00115$:
;	main.c:44: P0 = ins_write_data;
	mov	_P0,#0x01
;	main.c:45: P0 = ins_idle;
	mov	_P0,#0x00
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:51: void read_r() {
;	-----------------------------------------
;	 function read_r
;	-----------------------------------------
_read_r:
;	main.c:52: P0 = ins_read_r;
	mov	_P0,#0x03
;	main.c:53: while (P1 == 0) {}
00101$:
	mov	a,_P1
	jz	00101$
;	main.c:54: P0 = ins_ack;
	mov	_P0,#0x04
;	main.c:56: P0 = ins_idle;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:59: void montgomery() {
;	-----------------------------------------
;	 function montgomery
;	-----------------------------------------
_montgomery:
;	main.c:60: P0 = ins_montgomery;
	mov	_P0,#0x02
...
;	-----------------------------------------
_main:
;	main.c:69: write_montgomery();
	lcall	_write_montgomery
;	main.c:71: startBrk=1;
	mov	dptr,#_startBrk
	mov	a,#0x01
	movx	@dptr,a
;	main.c:73: montgomery();
	lcall	_montgomery
;	main.c:75: endBrk=1;
	mov	dptr,#_endBrk
	mov	a,#0x01
...
;	main.c:81: for (i = 0; i < SIZE; i++) {
	...
	sjmp	00104$
00107$:
;	main.c:85: P0 = ins_write_data;
	mov	_P0,#0x01
;	main.c:86: P0 = ins_idle;
	mov	_P0,#0x00
;	main.c:88: while (P1 == 0) {}
00101$:
	mov	a,_P1
	jz	00101$
;	main.c:89: P0 = ins_ack;
	mov	_P0,#0x04
;	main.c:91: terminate();
	lcall	_terminate
;	main.c:92: return 0;
