...
; This file was generated Sun Dec  2 14:20:21 2012
;--------------------------------------------------------
	.module main
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:22: void write_montgomery() {
;	-----------------------------------------
...
00104$:
	...
	subb	a,#0x00
	jnc	00107$
;	main.c:26: shared_a[i] = a[SIZE-1-i];
	mov	r2,_i
	mov	a,#(_shared_a >> 8)
	add	a,(_i + 1)
	mov	r3,a
...
00108$:
	...
	subb	a,#0x00
	jnc	00111$
;	main.c:30: shared_b[i] = b[SIZE-1-i];
	mov	a,_i
	add	a,#_shared_b
	mov	r2,a
	mov	a,(_i + 1)
...
00112$:
	...
	subb	a,#0x00
	jnc	00115$
;	main.c:34: shared_m[i] = m[SIZE-1-i];
	mov	r2,_i
	mov	a,#(_shared_m >> 8)
	add	a,(_i + 1)
	mov	r3,a
...
;	main.c:33: for (i = 0; i < SIZE; i++) {
	...
	sjmp	00112$
00115$:
;	main.c:37: P0 = ins_write_data;
	mov	_P0,#0x01
;	main.c:38: P0 = ins_idle;
	mov	_P0,#0x00
;	main.c:40: while (P1 == 0) {}
00101$:
	mov	a,_P1
	jz	00101$
;	main.c:41: P0 = ins_ack;
	mov	_P0,#0x04
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:44: void read_r() {
;	-----------------------------------------
;	 function read_r
;	-----------------------------------------
_read_r:
;	main.c:45: P0 = ins_read_r;
	mov	_P0,#0x03
;	main.c:46: while (P1 == 0) {}
00101$:
	mov	a,_P1
	jz	00101$
;	main.c:47: P0 = ins_ack;
	mov	_P0,#0x04
;	main.c:49: P0 = ins_idle;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:52: void montgomery() {
;	-----------------------------------------
;	 function montgomery
;	-----------------------------------------
_montgomery:
;	main.c:53: P0 = ins_montgomery;
	mov	_P0,#0x02
;	main.c:54: P0 = ins_idle;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;	-----------------------------------------
_main:
;	main.c:62: write_montgomery();
	lcall	_write_montgomery
;	main.c:63: montgomery();
	lcall	_montgomery
;	main.c:64: read_r();
	lcall	_read_r
;	main.c:66: P1 = 0;
;	main.c:68: for (i = 0; i < SIZE; i++) {
	clr	a
	mov	_P1,a
	mov	_i,a
	mov	(_i + 1),a
...
;	main.c:68: for (i = 0; i < SIZE; i++) {
	...
	sjmp	00104$
00107$:
;	main.c:72: P0 = ins_write_data;
	mov	_P0,#0x01
;	main.c:73: P0 = ins_idle;
	mov	_P0,#0x00
;	main.c:75: while (P1 == 0) {}
00101$:
	mov	a,_P1
	jz	00101$
;	main.c:76: P0 = ins_ack;
	mov	_P0,#0x04
;	main.c:78: terminate();
	lcall	_terminate
;	main.c:79: return 0;
