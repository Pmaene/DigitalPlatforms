...
; This file was generated Sat Aug  3 02:25:29 2013
;--------------------------------------------------------
	.module main
...
;	main.c:24: volatile __xdata __at (0x1100) unsigned char message[SIZE] = {};
	...
	mov	a,#0x98
	movx	@dptr,a
;	main.c:25: volatile __xdata __at (0x1200) unsigned char publicKey[SIZE] = {0x01, 0x01};
	mov	dptr,#_publicKey
	mov	a,#0x01
	movx	@dptr,a
...
_main:
	...
	ar0 = 0x00
	ar1 = 0x01
;	main.c:56: montModExp(0x20, 0x11, publicKey, 0x10, 0x14, 0x15);
	mov	_montModExp_PARM_3,#_publicKey
	mov	(_montModExp_PARM_3 + 1),#(_publicKey >> 8)
	mov	(_montModExp_PARM_3 + 2),#0x00
	mov	_montModExp_PARM_2,#0x11
	mov	_montModExp_PARM_4,#0x10
	mov	_montModExp_PARM_5,#0x14
	mov	_montModExp_PARM_6,#0x15
	mov	dpl,#0x20
	lcall	_montModExp
;	main.c:57: _displayResult();
	lcall	__displayResult
;	main.c:60: montModExp(0x21, 0x20, privateKey, 0x10, 0x14, 0x15);
	...
	mov	dpl,#0x21
	lcall	_montModExp
;	main.c:61: _displayResult();
	lcall	__displayResult
;	main.c:63: _terminate();
	lcall	__terminate
;	main.c:64: return 0;
	mov	dptr,#0x0000
	ret
...
;------------------------------------------------------------
;	main.c:67: void montModExp(unsigned char r, unsigned char x, unsigned char *e, unsigned char m, unsigned char rmodm, unsigned char r2modm) {
;	-----------------------------------------
;	 function montModExp
;	-----------------------------------------
_montModExp:
...
;	main.c:76: *one = 0x01;
	...
	mov	a,#0x01
	movx	@dptr,a
;	main.c:79: _writeModulus(m);
	mov	dpl,_montModExp_PARM_4
	lcall	__writeModulus
;	main.c:83: _writeA_Mem(x);
	mov	dpl,_montModExp_PARM_2
	lcall	__writeA_Mem
;	main.c:84: _writeB_Mem(r2modm);
	mov	dpl,_montModExp_PARM_6
	lcall	__writeB_Mem
;	main.c:85: _mul_montgomery();
	lcall	__mul_montgomery
;	main.c:86: _readResult(0x01);
	mov	dpl,#0x01
	lcall	__readResult
;	main.c:89: t = 0;
;	main.c:90: for (i = 0; i < SIZE; i++) {
	clr	a
...
;	main.c:91: if (e[(SIZE-1)-i] != 0) {
	...
	lcall	__gptrget
	jz	00116$
;	main.c:92: for (j = 0; j < 8; j++) {
	mov	r6,#0x00
00110$:
	cjne	r6,#0x08,00137$
00137$:
	jnc	00116$
;	main.c:93: if (e[(SIZE-1)-i] >> (7-j) & 1) {
...
;	main.c:90: for (i = 0; i < SIZE; i++) {
	...
	ljmp	00114$
;	main.c:101: breakLoop:
00105$:
;	main.c:104: _writeResult(rmodm);
	mov	dpl,_montModExp_PARM_5
	lcall	__writeResult
;	main.c:105: if (((e[t/8] >> t%8)) & 1) {
...
00143$:
	djnz	b,00142$
	jnb	acc.0,00133$
;	main.c:108: _writeA_Mem(0x01);
	mov	dpl,#0x01
	lcall	__writeA_Mem
;	main.c:109: _writeB_Reg();
	lcall	__writeB_Reg
;	main.c:110: _mul_montgomery();
	lcall	__mul_montgomery
;	main.c:113: for (k = 1; k <= t; k++) {
00133$:
	mov	r2,#0x01
	mov	r3,#0x00
00118$:
	...
	subb	a,r3
	jc	00121$
;	main.c:115: _writeA_Reg();
	push	ar2
	push	ar3
	lcall	__writeA_Reg
;	main.c:116: _writeB_Reg();
	lcall	__writeB_Reg
;	main.c:117: _mul_montgomery();
	lcall	__mul_montgomery
	pop	ar3
	pop	ar2
;	main.c:119: if (((e[(t-k)/8] >> (t-k)%8)) & 1) {
	mov	a,_montModExp_t_1_1
	clr	c
	subb	a,r2
	mov	r4,a
...
00147$:
	djnz	b,00146$
	jnb	acc.0,00120$
;	main.c:122: _writeA_Mem(0x01);
	mov	dpl,#0x01
	push	ar2
	push	ar3
	lcall	__writeA_Mem
;	main.c:123: _writeB_Reg();
	lcall	__writeB_Reg
...
;	main.c:113: for (k = 1; k <= t; k++) {
	...
	sjmp	00118$
00121$:
;	main.c:130: _writeA_Mem(0x00);
	mov	dpl,#0x00
	lcall	__writeA_Mem
;	main.c:131: _writeB_Reg();
	lcall	__writeB_Reg
;	main.c:132: _mul_montgomery();
	lcall	__mul_montgomery
;	main.c:133: _readResult(r);
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:137: static inline void _displayCycles() {
;	-----------------------------------------
;	 function _displayCycles
;	-----------------------------------------
__displayCycles:
;	main.c:138: P0 = INS_DISPLAY_CYCLES;
	mov	_P0,#0x01
;	main.c:139: P0 = INS_IDLE;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:142: static inline void _displayResult() {
;	-----------------------------------------
;	 function _displayResult
;	-----------------------------------------
__displayResult:
;	main.c:143: P0 = INS_DISPLAY_RESULT;
	mov	_P0,#0x02
;	main.c:144: P0 = INS_IDLE;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	main.c:147: static inline void _writeModulus(unsigned char address) {
;	-----------------------------------------
;	 function _writeModulus
;	-----------------------------------------
__writeModulus:
	mov	r2,dpl
;	main.c:148: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00113$
	sjmp	00101$
...
;	main.c:150: P2 = 0;
	mov	_P2,#0x00
;	main.c:151: P1 = address;
	mov	_P1,r2
;	main.c:153: P0 = INS_WRITE_MODULUS;
	mov	_P0,#0x10
;	main.c:154: P0 = INS_IDLE;
	mov	_P0,#0x00
;	main.c:156: while (P2 == 0) {}
00104$:
	mov	a,_P2
	jz	00104$
;	main.c:157: P0 = INS_ACK;
	mov	_P0,#0x0F
	ret
;------------------------------------------------------------
...
;address                   Allocated to registers r2 
;------------------------------------------------------------
;	main.c:160: static inline void _writeA_Mem(unsigned char address) {
;	-----------------------------------------
;	 function _writeA_Mem
;	-----------------------------------------
__writeA_Mem:
	mov	r2,dpl
;	main.c:161: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00113$
	sjmp	00101$
...
;	main.c:163: P2 = 0;
	mov	_P2,#0x00
;	main.c:164: P1 = address;
	mov	_P1,r2
;	main.c:166: P0 = INS_WRITE_A_MEM;
	mov	_P0,#0x11
;	main.c:167: P0 = INS_IDLE;
	mov	_P0,#0x00
;	main.c:169: while (P2 == 0) {}
00104$:
	mov	a,_P2
	jz	00104$
;	main.c:170: P0 = INS_ACK;
	mov	_P0,#0x0F
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:173: static inline void _writeA_Reg() {
;	-----------------------------------------
;	 function _writeA_Reg
;	-----------------------------------------
__writeA_Reg:
;	main.c:174: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00108$
	sjmp	00101$
00108$:
;	main.c:176: P0 = INS_WRITE_A_REG;
	mov	_P0,#0x12
;	main.c:177: P0 = INS_IDLE;
	mov	_P0,#0x00
	ret
;------------------------------------------------------------
...
;address                   Allocated to registers r2 
;------------------------------------------------------------
;	main.c:180: static inline void _writeB_Mem(unsigned char address) {
;	-----------------------------------------
;	 function _writeB_Mem
;	-----------------------------------------
__writeB_Mem:
	mov	r2,dpl
;	main.c:181: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00113$
	sjmp	00101$
...
;	main.c:183: P2 = 0;
	mov	_P2,#0x00
;	main.c:184: P1 = address;
	mov	_P1,r2
;	main.c:186: P0 = INS_WRITE_B_MEM;
	mov	_P0,#0x13
;	main.c:187: P0 = INS_IDLE;
	mov	_P0,#0x00
;	main.c:189: while (P2 == 0) {}
00104$:
	mov	a,_P2
	jz	00104$
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:193: static inline void _writeB_Reg() {
;	-----------------------------------------
;	 function _writeB_Reg
;	-----------------------------------------
__writeB_Reg:
;	main.c:194: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00108$
	sjmp	00101$
00108$:
;	main.c:196: P0 = INS_WRITE_B_REG;
	mov	_P0,#0x14
...
;address                   Allocated to registers r2 
;------------------------------------------------------------
;	main.c:200: static inline void _writeResult(unsigned char address) {
;	-----------------------------------------
;	 function _writeResult
;	-----------------------------------------
__writeResult:
	mov	r2,dpl
;	main.c:201: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00113$
	sjmp	00101$
...
;	main.c:203: P2 = 0;
	mov	_P2,#0x00
;	main.c:204: P1 = address;
	mov	_P1,r2
;	main.c:206: P0 = INS_WRITE_RESULT;
	mov	_P0,#0x15
;	main.c:207: P0 = INS_IDLE;
	mov	_P0,#0x00
;	main.c:209: while (P2 == 0) {}
00104$:
	mov	a,_P2
	jz	00104$
;	main.c:210: P0 = INS_ACK;
	mov	_P0,#0x0F
	ret
;------------------------------------------------------------
...
;address                   Allocated to registers r2 
;------------------------------------------------------------
;	main.c:213: static inline void _readResult(unsigned char address) {
;	-----------------------------------------
;	 function _readResult
;	-----------------------------------------
__readResult:
	mov	r2,dpl
;	main.c:214: while (P2 == 2) {}
00101$:
	mov	a,#0x02
	cjne	a,_P2,00113$
	sjmp	00101$
...
;	main.c:216: P2 = 0;
	mov	_P2,#0x00
;	main.c:217: P1 = address;
	mov	_P1,r2
;	main.c:219: P0 = INS_READ_RESULT;
	mov	_P0,#0x16
;	main.c:220: P0 = INS_IDLE;
	mov	_P0,#0x00
;	main.c:222: while (P2 == 0) {}
00104$:
	mov	a,_P2
	jz	00104$
;	main.c:223: P0 = INS_ACK;
	mov	_P0,#0x0F
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:226: static inline void _mul_montgomery() {
;	-----------------------------------------
...
;	main.c:227: P2 = 0;
	mov	_P2,#0x00
;	main.c:229: P0 = INS_MUL_MONTGOMERY;
	mov	_P0,#0x20
...
;------------------------------------------------------------
;------------------------------------------------------------
;	main.c:233: static inline void _terminate() {
;	-----------------------------------------
;	 function _terminate
;	-----------------------------------------
__terminate:
